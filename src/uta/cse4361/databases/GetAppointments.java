    ...
    public void processResult() {
        try {
            ...
            while (resultSet.next()) {
                ...
                String cEnr = resultSet.getString("CoursesEnrolled");
                String pri = resultSet.getString("AppointmentPriority");
                appt.setApptID(id);
                if (appt.initialize(sMajor, sName, sID, sEmail, aName, type, description, date, sHour, eHour, sMinute, eMinute,dur,sem,cEnr,pri)) {
