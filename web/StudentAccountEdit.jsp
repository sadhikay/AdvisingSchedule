...
<html>
    <head>
        ...
        <jsp:setProperty name="newadvisor" property="question" value='<%=request.getParameter("question")%>'/>
        <jsp:setProperty name="newadvisor" property="answer" value='<%=request.getParameter("answer")%>'/>
        <jsp:setProperty name="newadvisor" property="phone" value='<%=request.getParameter("phone")%>'/>
        <jsp:setProperty name="newadvisor" property="contact" value='<%=request.getParameter("contact")%>'/>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="accordion">
                ...
                <div>
                <%
                    newadvisor.setQuestion(request.getParameter("question"));
                    newadvisor.setAnswer(request.getParameter("answer"));
                    newadvisor.setPhone(request.getParameter("phone"));
                    newadvisor.setContact(request.getParameter("contact"));
